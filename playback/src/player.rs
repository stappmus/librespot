...
mod tests {
    use super::{
        LoadError, MANUAL_TRACK_SWITCH_FADE_FRAMES, MANUAL_TRACK_SWITCH_FADE_SAMPLES, PlayerEvent,
        PlayerTrackLoader, apply_manual_track_switch_fade_in, manual_track_switch_fade_out,
    };
